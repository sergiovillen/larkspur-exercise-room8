...
EXTRA_TOOLS: List[Dict[str, Any]] = [    # ✏️ Build 2, step 2.1: schemas for the tools you add
    {
        "name": "fare_rules",
        "description": (
            "Return the Larkspur Handbook text for one policy section by number or keyword. "
            "Use this when a customer asks why a specific entitlement was denied or wants the "
            "exact policy wording. Pass the section number (e.g. '6') or a keyword from the "
            "title (e.g. 'hotel'). Always cite the section returned."
        ),
        "input_schema": {
            "type": "object",
            "properties": {
                "section": {
                    "type": "string",
                    "description": "Section number (e.g. '6') or a keyword from the section title (e.g. 'hotel', 'meal').",
                },
            },
            "required": ["section"],
        },
...
LOCAL_TOOLS: Dict[str, Any] = {          # ✏️ Build 2, step 2.1: the functions behind them
    "fare_rules": lambda **kwargs: mcp_client.call_remote("fare_rules", kwargs),
}
