...
TONE_ADDENDUM = (                        # ✏️ Build 4, step 4.1, intelligence lane
    "\n\nTONE ESCALATION: If the customer uses abusive language, insults, or makes legal "
    "threats (e.g. 'calling my lawyer', 'sue you', explicit profanity directed at staff), "
    "do NOT proceed with a normal entitlements response. Acknowledge the frustration briefly "
    "in one sentence, then immediately call escalate_to_human. Do not offer refunds, vouchers, "
    "or rebooking options into a legal threat. A human agent will take it from there."
)
    ...
    return [
        {
            ...
            "description": (
                ...
                "and the passenger's last name. Both are required to prevent a lookup on a "
                "guessed PNR. Returns fare family, loyalty tier, the segment that needs "
        ...
        },
        {
            ...
            "description": (
                ...
                "Date must be in YYYY-MM-DD format, for example 2025-05-08."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": (
                "Search for alternative Larkspur flights available for rebooking. Call this "
                "after confirming the customer has a valid waiver. Takes the PNR and returns "
                "available options with option_id, flight details, and fare information."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": (
                ...
                "is overnight are looked up from the booking, not asked of you. Every response "
                "carries a policy_row_id. Cite it if you reference this decision again."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            "name": "hold_seat",
            "description": (
                "Place a 15-minute hold on one alternative. Reversible. It simply expires."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": (
                "Finalize a held seat. Irreversible. Requires a confirmation_token that only "
                "the customer's own Confirm-click can produce. You cannot supply it yourself, "
                "and 'the customer said yes' in chat does not substitute for it."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
        ...
        },
        {
            ...
            "description": (
                "Send the customer a written confirmation of what was just done. Benign."
            ),
            "input_schema": {
                "type": "object",
                "properties": {
