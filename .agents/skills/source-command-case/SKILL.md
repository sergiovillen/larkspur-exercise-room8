---
name: "source-command-case"
description: "Migrated source command `case`"
---

# source-command-case

Use this skill when the user asks to run the migrated source command `case`.

## Command Template

Build one eval case with the person, for step 3.1. Follow AGENTS.md's contract: they decide, you
