---
name: "source-command-readout"
description: "Migrated source command `readout`"
---

# source-command-readout

Use this skill when the user asks to run the migrated source command `readout`.
